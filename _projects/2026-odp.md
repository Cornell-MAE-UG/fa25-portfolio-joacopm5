...
* 3 — Many eggs are laid on high surfaces; 98% of eggs are found at unreachable heights (+10 feet) on trees. Test attachments to extendable tools for users to reach higher egg masses.
...
\begin{itemize}[leftmargin=1.5em, labelsep=0pt, itemindent=-1.5em]
    \item New York State Integrated Pest Management. (n.d.). \textit{Spotted lanternfly management}. Cornell CALS College of Agriculture and Life Sciences. \url{https://cals.cornell.edu/integrated-pest-management/outreach-education/whats-bugging-you/spotted-lanternfly}

    \item Hayes, C. (2025, January 27). \textit{Spotted lanternflies could cost NYS grape industry millions}. Cornell Chronicle. \url{https://news.cornell.edu/stories/2025/01/spotted-lanternflies-could-cost-nys-grape-industry-millions}

    \item Krawczyk, G. (2023, August 30). \textit{What should you do with spotted lanternfly egg masses?} PennState Extension. \url{https://extension.psu.edu/what-should-you-do-with-spotted-lanternfly-egg-masses}
\end{itemize}

## Figure

![Average SLFs per Vine (2018-2020)](/assets/images/avg_slf_per_vine.png)
