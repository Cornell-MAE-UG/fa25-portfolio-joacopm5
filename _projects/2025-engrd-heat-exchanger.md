...
Matching the capacity rates, 
\[
\dot{m}_H c_{p,H} \approx \dot{m}_C c_{p,C},
\]
on both sides (as suggested by our counterflow data) maximizes the effectiveness of the heat exchanger.
